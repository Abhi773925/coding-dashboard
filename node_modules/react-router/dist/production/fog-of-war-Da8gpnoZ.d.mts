...
/**
  Renders all of the `<a>` tags created by route module {@link LinksFunction} export. You should render it inside the `<head>` of your document.
...
interface LinkProps extends Omit<React.AnchorHTMLAttributes<HTMLAnchorElement>, "href"> {
    ...
    */
    ...
    /**
      ...
      ```tsx
      <a href="/somewhere/else" state={{ some: "value" }} />
      ```
    ...
    /**
      ...
      ```tsx
      <a href="?tab=one" preventScrollReset />
      ```
     */
    preventScrollReset?: boolean;
    /**
...
/**
  Wraps {@link Link | `<a>`} with additional props for styling active and pending states.
...
/**
 * Handles the click behavior for router `<a>` components. This is useful if
 * you need to create custom `<a>` components with the same click behavior we
 * use in our exported `<a>`.
 *
 * @category Hooks
 */
