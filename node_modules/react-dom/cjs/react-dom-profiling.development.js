          ...
          if (
            ...
            if (currentProps && null === currentResource)
              throw (
                ...
                Error(
                  "Expected <a> not to update to be updated to a stylesheet with precedence. Check the `rel`, `href`, and `precedence` props of this component. Alternatively, check whether two different <a> components render in the same slot or share the same key." +
                    pendingProps
                ))
              );
            return _resource;
          ...
          if (currentProps && null !== currentResource)
            throw (
              ((pendingProps =
                ...
                describeLinkForResourceErrorDEV(pendingProps)),
              Error(
                "Expected stylesheet with precedence to not be updated to a different kind of <a>. Check the `rel`, `href`, and `precedence` props of this component. Alternatively, check whether two different <a> components render in the same slot or share the same key." +
                  pendingProps
              ))
            );
          return null;
        ...
        case "link":
          if (
            ...
            outsideHostContainerContext &&
              ...
              "" === props.href
                ? console.error(
                    "Cannot render a <a> outside the main document without a `rel` and `href` prop. Try adding a `rel` and/or `href` prop to this <a> or moving the link into the <head> tag"
                  )
                : (props.onError || props.onLoad) &&
                  console.error(
                    "Cannot render a <a> with onLoad or onError listeners outside the main document. Try removing onLoad={...} and onError={...} or moving it into the root <head> tag or somewhere in the <body>."
                  ));
            break;
          }
          switch (props.rel) {
