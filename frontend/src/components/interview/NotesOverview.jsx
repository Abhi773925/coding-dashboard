...
import { useTheme } from "../context/ThemeContext" // Adjust this if needed

// ✅ Custom Card Components (basic version)
...
export default function NotesOverview() {
  ...
  return (
    <div
      className={`min-h-screen flex flex-col items-center justify-center py-12 transition-all duration-500 ${
        isDarkMode
          ? "bg-gradient-to-br from-slate-900 via-slate-900 to-slate-900 text-gray-100"
    ...
    >
      <div className="text-center mb-12">
        <h1 className="text-5xl md:text-6xl font-black mb-4 bg-gradient-to-r from-blue-500 via-purple-500 to-pink-500 bg-clip-text text-transparent animate-pulse">
          My Notes Hub
        </h1>
